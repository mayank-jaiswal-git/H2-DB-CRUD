...
## 👤 Author
- Mayank Jaiswal (SanviiTechmet)

## 📜 License
- MIT License (or specify the license you prefer)

---

If you want, I can also add a `CONTRIBUTING.md`, a `Dockerfile` for containerized runs, or create a Postman collection with examples. Which would you like next? 💡
